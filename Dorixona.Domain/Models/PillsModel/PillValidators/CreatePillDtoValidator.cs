...
public class CreatePillDtoValidator : AbstractValidator<CreatePillDto>
{
    public CreatePillDtoValidator()
    {
        RuleFor(x => x.Name)
        ...
        RuleFor(x => x.ManufactureDate)
            ...
            .LessThanOrEqualTo(DateTime.UtcNow).WithMessage("Ishlab chiqarilgan sana bugungi kundan keyin bo‘lmasligi kerak.");

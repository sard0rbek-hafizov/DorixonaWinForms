...
public class FilterAvailablePillsQuery : IRequest<IEnumerable<Pill>>
{
    public string? SearchTerm { get; set; }
    public Guid? PharmacyId { get; set; }

    public class Handler : IRequestHandler<FilterAvailablePillsQuery, IEnumerable<Pill>>
    {
        ...
        public async Task<IEnumerable<Pill>> Handle(FilterAvailablePillsQuery request, CancellationToken cancellationToken)
        {
